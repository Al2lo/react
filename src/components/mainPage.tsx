...
import filters from '../objects/filtersArr';
import vacations from '../objects/vacationsArr';
import VacationCatalog from './VacationCatalog';
import vacs from '../objects/vacationsArr'
...
export default function MainPage({vacs, dispatch} : {vacs: IVacation[], dispatch : any}) {
  ...
  return (
    <div className='MenuFilter'>
        ...
        <ContainerCompForWorks setCurrent={undefined} />
        {
        <ConteinerCom />
        }
        </div>
